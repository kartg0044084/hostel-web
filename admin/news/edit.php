...
<div class="title">
    ...
    <li class="breadcrumb-item active">修改訊息</li>
    </ol>
    ...
    <form class="form-horizontal" role="form" data-toggle="validator" action="add.php" method="POST">
     ...
     <div class="form-group">
       ...
       <div class="col-sm-10">
         <input type="text" class="form-control" id="published_date" name="published_date" value="<?php echo $news['publishedDate'];?>" data-error="請輸入字元" required>
